...
- **What is the victim’s IP address?** $\color{blue}{\text{192.168.1.27}}$
 
![img6.png](https://github.com/ETEKTrooper/wireshark_analysis/blob/main/img6.png?raw=true)

- **What is the victim’s MAC address?** $\color{blue}{\text{bc:ea:fa:22:74:fb}}$
...
- **When did the malicious traffic start in UTC?** $\color{blue}{\text{05 Jan 2023 22:51:00}}$
...
- **What is the victim’s Windows host name?** $\color{blue}{\text{DESKTOP-WIN11PC}}$ 
...
- **What is the victim’s Windows user account name?** $\color{blue}{\text{windows11user}}$ 
...
- **What type of CPU is used by the victim’s host?** $\color{blue}{\text{Intel® Core™ i5-13600K CPU @ 5.10GHz}}$ 
  
![img12.png](https://github.com/ETEKTrooper/wireshark_analysis/blob/main/img12.png?raw=true)

- **How much RAM does the victim’s host have?** $\color{blue}{\text{32GB}}$ 
...
- **What is the public IP address of the victim’s host?** $\color{blue}{\text{173.66.46.112}}$ 
...
- **What type of account login data was stolen by the malware?** $\color{blue}{\text{The malware stole usernames and passwords from multiple accounts, including email, social media, and shopping websites.}}$ 
